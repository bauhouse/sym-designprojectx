...
URL: http://symphony21.com/downloads/xslt/file/20506/

Parameters:
* date (required) an ISO date 2005-12-01)
...
<xsl:template name="format-date">
	...
	<xsl:choose>
		...
		<xsl:otherwise>
			<xsl:text>Error: format parameter is not correctly set. 13 is the maximum character limit. You have: </xsl:text>
...
<xsl:template name="date-controller">
	...
	<xsl:param name="tletter" select="translate($letter,'YMNDTW','ymndtw')"/>
