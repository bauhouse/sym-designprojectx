...
<xsl:template name="grid-960-css">
	...
	<link rel="stylesheet" type="text/css" href="{$css-path}reset.css" media="all" />
	<link rel="stylesheet" type="text/css" href="{$css-path}text.css" media="all" />
	<link rel="stylesheet" type="text/css" href="{$css-path}960.css" media="all" />
	<link rel="stylesheet" type="text/css" href="{$css-path}layout.css" media="all" />
	<link rel="stylesheet" type="text/css" href="{$css-path}nav.css" media="all" />
</xsl:template>
...
<xsl:template name="grid-calendar-css">
	...
	<link rel="stylesheet" type="text/css" href="{$css-path}text.css" media="all" />
	<link rel="stylesheet" type="text/css" href="{$css-path}grids.css" media="all" />
	<link rel="stylesheet" type="text/css" href="{$css-path}calendar-layout.css" media="all" />
			...
			<ol>
				<li class="comment" id="comment-1">
					<div class="comment-meta">
						<a href="http://www.domain7.com/" class="avatar"><img src="{$workspace}/public/img/photo_60x60.jpg" width="30" height="30" alt="photo"/></a>
						<ul>
...
<xsl:template name="grid-forum-topics">
	...
	<xsl:param name="topic-link" select="concat($root,'/messages/topic/')"/>
	<div class="mod">
	...
	<div class="box articles">
		...
		<div class="block" id="{$articles-handle}">
			<div class="first article">
				...
				<a href="{$root}/news/article/" class="image"><img src="{$workspace}/public/img/photo_60x60.jpg" width="60" height="60" alt="photo"/></a>
...
<xsl:template name="grid-site-info">
	<div class="box">
		<p>&#169; Copyright <xsl:value-of select="$this-year"/><xsl:text> </xsl:text><a href="http://www.ugm.ca/">Union Gospel Mission</a>. All rights reserved.</p>
	</div>
</xsl:template>
