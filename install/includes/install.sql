...
CREATE TABLE`tbl_sections` (
  ...
  `navigation_group` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `filter` enum('yes','no') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'yes',
  `author_id` int(11) unsigned NOT NULL DEFAULT 1,
  `modification_author_id` int(11) unsigned NOT NULL DEFAULT 1,
  `creation_date` datetime NOT NULL DEFAULT '2020-04-10 14:01:57',
  `creation_date_gmt` datetime NOT NULL DEFAULT '2020-04-10 21:01:57',
  `modification_date` datetime NOT NULL DEFAULT '2020-04-10 14:01:57',
  `modification_date_gmt` datetime NOT NULL DEFAULT '2020-04-10 21:01:57',
  PRIMARY KEY (`id`),
