...
<xsl:template name="content-thumbnails">
	...
	<a href="{$root}/people/" class="photo"><img src="{$workspace}/public/img/photo_60x60.jpg" alt="Staff photo" title="Jane Smith" /></a>
...
<xsl:template name="content-thumbnails-small">
	...
	<a href="{$root}/people/" class="photo"><img width="30" height="30" src="{$workspace}/public/img/photo_60x60.jpg" alt="Staff photo" title="Jane Smith" /></a>
