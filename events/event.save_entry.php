<?php
	...
	Class eventsave_entry extends Event{
		
		const ROOTELEMENT = 'save-entry';
		...
		public static function about(){
			return array(
					 ...
					 'version' => '1.0',
					 'release-date' => '2009-05-25T19:43:41+00:00',
					 'trigger-condition' => 'action[save-entry]');	
		}
        ...
        <pre class="XML"><code>&lt;save-entry result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/save-entry></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;save-entry result="error">
...
&lt;/form></code></pre>
		...
		public function load(){			
			if(isset($_POST['action']['save-entry'])) return $this->__trigger();
		}
